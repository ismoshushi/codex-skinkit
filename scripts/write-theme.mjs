...
if (mode === "reset-demo") {
  ...
  console.log("Restored the bundled portal demo preset.");
  process.exit(0);
}
...
const name = valueFor("name", "My Codex SkinKit Theme").trim().slice(0, 80);
...
const custom = {
  schemaVersion: 1,
  id: `custom-${Date.now()}`,
  name: name || "My Codex SkinKit Theme",
  brandSubtitle: "CODEX SKINKIT",
  tagline: tagline || "把喜欢的画面变成可交互的 Codex 工作台。",
  projectPrefix: "选择项目 · ",
  projectLabel: "◉  选择项目",
  statusText: "SKINKIT ONLINE",
