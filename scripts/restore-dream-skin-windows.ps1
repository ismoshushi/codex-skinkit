...
if ($Uninstall) {
  Get-ChildItem ([Environment]::GetFolderPath('Desktop')) -Filter 'Codex SkinKit*.cmd' | Remove-Item -Force
  Remove-Item -LiteralPath $WatchdogStartupPath -Force -ErrorAction SilentlyContinue
}
